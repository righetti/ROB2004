...
You can run the Jupyter notebook for the project either using a local installation of Python on your computer. Please reach out as soon as possible if you have issues doing this.
