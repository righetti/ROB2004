...
class Simulator:
    def __init__(self):
        ...
        redcube = p.loadURDF("./urdf/red_block.urdf")
        p.resetBasePositionAndOrientation(redcube, [0.35,0.58,0.65], (0., 0., 0., 1.))
        
        greencube = p.loadURDF("./urdf/green_block.urdf")
        p.resetBasePositionAndOrientation(greencube, [0.2,0.58,0.65], (0., 0., 0., 1.))

        bluecube = p.loadURDF("./urdf/blue_block.urdf")
        p.resetBasePositionAndOrientation(bluecube, [0.0,0.58,0.65], (0., 0., 0., 1.))
